...
export default function EditExperiencePage() {
  ...
  const [model, setModel] = useState<Experience | null>(null);
  ...
  useEffect(() => {
    (async () => setModel(await getExperienceById(id)))();
  }, [id]);
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await updateExperience(model.id, {
        title: model.title,
        type: model.type,
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="mb-8 animate-fadeIn">
        ...
        <div className="inline-flex items-center px-4 py-2 glass rounded-xl border border-white/20 text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <span className="font-mono">ID: {model.id.substring(0, 8)}...</span>
        </div>
      </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                value={model.type}
                onChange={(e) =>
                  setModel({ ...model, type: e.target.value as any })
                }
              >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  setModel({ ...model, mediaUrl: e.target.value })
                }
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  setModel({ ...model, thumbnailUrl: e.target.value })
                }
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  Las experiencias activas pueden ser escaneadas y visualizadas
                  por los usuarios en tiempo real
                </p>
              </div>
              <div
                className={`w-3 h-3 rounded-full ${
                  model.isActive ? "bg-green-500 animate-pulse" : "bg-gray-400"
                } transition-colors`}
              ></div>
            </div>
          </div>
